...
2. **Read every emitted file.** Frontmatter, body, READMEs, install scripts. Do not skim — the whole point of this review is prompt quality, which lives in the wording.
